...
//
//	mockgen -typed -package quic -self_package github.com/ruk1ng001/quic-go-upgrade -self_package github.com/ruk1ng001/quic-go-upgrade -destination mock_packetconn_test.go net PacketConn
//
