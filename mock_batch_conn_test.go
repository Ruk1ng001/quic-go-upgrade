...
//
//	mockgen -typed -package quic -self_package github.com/ruk1ng001/quic-go-upgrade -source sys_conn_oob.go -destination mock_batch_conn_test.go -mock_names batchConn=MockBatchConn
//
